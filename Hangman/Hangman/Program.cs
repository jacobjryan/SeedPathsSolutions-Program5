...
namespace Hangman
{
    class Program
    {
        ...
        static void Hangman()
        {
            //declare the variables that we need to keep
            // track of
            ...
            while (playing)
            {
                ...
                if (input.Length == 1)
                {
                    //its a letter guess, add it to the letters guessed string
            ...
            //game ended, decide if they've won or lost
            if (numberOfGuessesLeft > 0)
            {
                Console.WriteLine("You won, way to go big dog");
            }
            else
            {
                Console.WriteLine("You're bad at life and also this game");
            }
        ...
        static string GetUserInput(string lettersGuessed)
        {
            ...
            do
            {
                ...
                {
                    Console.WriteLine("You need to enter a letter or a word");
                    isValid = false;
                }
            ...
            //its a valid guess, return the string
            return returnString;
        }
    }
}
